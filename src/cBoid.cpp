...
// Distance controls
static const float localDist = 60;    // distance at which a boid considers itself in a mass
...
//--------------------------------------------------------------
cBoid::cBoid(int xpos, int ypos, int index)
    : m_pos{ xpos, ypos }, m_index(index)
{
}
